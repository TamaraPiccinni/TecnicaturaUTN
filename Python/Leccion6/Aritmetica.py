class Aritmetica:
    ...
    Vamos a hacer es esta clase algunas operaciones de: suma, resta, multiplicación y mas)
    """
...
print(f'La división de los números es: {aritmetica1.dividir():.2f}') # .2f es para que muestre solo 2 decimales
